                ...
                <div class="my-4">
                    <div class="flex justify-between px-4 py-3 bg-indigo-100 border border-indigo-200 rounded-t-lg">
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-2 text-sm hover:underline text-gray-600">committed 3 days ago</a>
                        </div>
                    ...
                    <div class="hidden text-center border-b border-l border-r rounded-b-lg md:block">
                        ...
                        <div class="flex px-4 py-2 text-sm hover:bg-gray-200">
                            ...
                            <p class="w-1/2 text-left cursor-pointer hover:underline hover:text-blue-600">Add empty .npmignore so dist files are distributed with releases</p>
                        ...
                        <div class="flex px-4 py-2 text-sm hover:bg-gray-200">
                            ...
                            <p class="w-1/2 text-left cursor-pointer hover:underline hover:text-blue-600">Don't generate color opacity code in color plugins if not necessary</p>
                        ...
                        <div class="flex px-4 py-2 text-sm hover:bg-gray-200">
                            ...
                            <p class="w-1/2 text-left cursor-pointer hover:underline hover:text-blue-600">Throw if contains a class</p>
